...
$userArray = db::getInstance()->get_result("select * from ".$DBPREFIX."user WHERE id = ".$uid." LIMIT 1");
...
$to = $userArray['email'];
	...
	if(time() < $subenddate){
		$message .= '<div class="txtTinyMce-wrapper" style="line-height: 1.2; font-size: 12px; color: #00FF00; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 14px;">
    <p style="font-size: 22px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Subscription Details</span></p>
    </div>
    ...
    <td width="50%" align="center" class="divider_inner" style="word-break: break-word; vertical-align: top; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;" valign="top">
    <div class="txtTinyMce-wrapper" style="line-height: 1.5; font-size: 12px; color: #00FF00; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px;">
    <p style="font-size: 18px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 42px; margin: 0;"><span style="font-size: 22px;"><strong><span style="">Start Date</span></strong></span></p>
    </div>
    </td>
    <td width="50%" align="center" class="divider_inner" style="word-break: break-word; vertical-align: top; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;" valign="top;">
    <div class="txtTinyMce-wrapper" style="line-height: 1.5; font-size: 12px; color: #00FF00; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px;">
    <p style="font-size: 18px; line-height: 1.5; text-align: center; word-break: break-word; mso-line-height-alt: 42px; margin: 0;"><span style="font-size: 22px;"><strong><span style="">End Date</span></strong></span></p>
    </div>
    </td>
    </tr>
    <tr>
    ...
    <tr style="vertical-align: top;" valign="top">
    <td width="50%" align="center" class="divider_inner" style="font-size: 20px; word-break: break-word; vertical-align: top; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;" valign="top">
    <font color="#FFFFFF">'.date("d-m-Y", $substartdate).'</font>
    </td>
    <td width="50%" align="center" class="divider_inner" style="font-size: 20px; word-break: break-word; vertical-align: top; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px;" valign="top">
    <font color="#FFFFFF">'.date("d-m-Y", $subenddate).'</font>
    </td>
    </tr>
    </tbody>
    </table>
